...
\begin{itemize}
    ...
    \item Las personas que trabajan una cantidad de horas superior a
      ...
      que no lo hacen
    \item En paises desarrollados, como estados unidos, existe una mayor cantidad
...
\begin{itemize}
    \item El promedio de ingresos de la poblacion mexicana es mayor
      que la peruana
    \item Las personas de mediana edad poseen una mejor distribución
      de ingreso que las personas jóvenes
